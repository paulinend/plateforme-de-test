...
public class App implements CommandLineRunner {
	...
	public void exampleCreation() {
      Test test = new Test("test avec question", 5, LocalDateTime.now(), LocalDateTime.now(), new HashSet<>());
      Question question = new Question(test, new HashSet<>(), Question.TypeQuestion.CHOIX_UNIQUE, "Ca marche ?", 2);
